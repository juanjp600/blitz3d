...
void sockets_link( void(*rtSym)(const char*,void*) ){
	...
	rtSym( "(BBStream)CreateUDPStream%port=0",bbCreateUDPStream );
	rtSym( "CloseUDPStream(BBStream)udp_stream",bbCloseUDPStream );
	rtSym( "SendUDPMsg(BBStream)udp_stream%dest_ip%dest_port=0",bbSendUDPMsg );
	rtSym( "%RecvUDPMsg(BBStream)udp_stream",bbRecvUDPMsg );
	rtSym( "%UDPStreamIP(BBStream)udp_stream",bbUDPStreamIP );
	rtSym( "%UDPStreamPort(BBStream)udp_stream",bbUDPStreamPort );
	rtSym( "%UDPMsgIP(BBStream)udp_stream",bbUDPMsgIP );
	rtSym( "%UDPMsgPort(BBStream)udp_stream",bbUDPMsgPort );
	rtSym( "UDPTimeouts%recv_timeout",bbUDPTimeouts );

	rtSym( "(BBStream)OpenTCPStream$server%server_port%local_port=0",bbOpenTCPStream );
	rtSym( "CloseTCPStream(BBStream)tcp_stream",bbCloseTCPStream );
	rtSym( "(BBTCPServer)CreateTCPServer%port",bbCreateTCPServer );
	rtSym( "CloseTCPServer(BBTCPServer)tcp_server",bbCloseTCPServer );
	rtSym( "(BBStream)AcceptTCPStream(BBTCPServer)tcp_server",bbAcceptTCPStream );
	rtSym( "%TCPStreamIP(BBStream)tcp_stream",bbTCPStreamIP );
	rtSym( "%TCPStreamPort(BBStream)tcp_stream",bbTCPStreamPort );
